...
/// [Sizes] defines custom size constants for the application's design.
/// The `Sizes` class encapsulates size constants used throughout the application.
///
/// All the available sizes are the following:
/// * p4
/// * p6
/// * p8
/// * p12
...
const SizedBox gapW36 = SizedBox(width: Sizes.p36);
...
const SizedBox gapH36 = SizedBox(height: Sizes.p36);
